...
public class UserControllerTest {
    ...
    @Test
    void 사용자는_특정_유저의_정보를_개인정보는_소거된_상태로_전달_받을_수_있다() {
        // given
    ...
    void 사용자는_인증_코드로_계정을_활성화_시킬_수_있다() {
        ...
        assertThat(user.getBody().getEmail()).isEqualTo("kok202@naver.com");
        assertThat(user.getBody().getNickname()).isEqualTo("kok202");
        assertThat(user.getBody().getStatus()).isEqualTo(UserStatus.ACTIVE);
        assertThat(user.getBody().getLastLoginAt()).isEqualTo(100L);
    }

    @Test
    void 사용자는_인증_코드가_일치하지_않을_경우_권한_없음_예외를_던진다() {
        // given
        TestContainer testContainer = TestContainer.builder()
                .build();
        testContainer.userRepository.save(User.builder()
    ...
    void 사용자는_내_정보를_수정할_수_있다() {
        ...
        assertThat(result.getBody().getId()).isEqualTo(1);
        assertThat(result.getBody().getEmail()).isEqualTo("kok202@naver.com");
        assertThat(result.getBody().getNickname()).isEqualTo("kok303");
        assertThat(result.getBody().getStatus()).isEqualTo(UserStatus.ACTIVE);
        assertThat(result.getBody().getLastLoginAt()).isEqualTo(100L);
